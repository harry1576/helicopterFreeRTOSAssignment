...
function loadHeliFiles() {
    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v1.1.12/heli_key_bindings.js');
    ...
    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v1.1.12/heli_menu.js');

    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v1.1.12/redesign_heli.js')
}
