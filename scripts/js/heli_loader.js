...
function loadHeliFiles() {
    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v0.1.1/heli_key_bindings.js');
    ...
    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v0.1.1/heli_menu.js');

    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v0.1.1/redesign_heli.js')
}
