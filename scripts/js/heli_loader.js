...
function loadHeliFiles() {
    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v0.1.0/heli_key_bindings.js');
    ...
    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v0.1.0/heli_menu.js');

    loadHeliJS('https://storage.googleapis.com/heli.ucquarantine.net/v0.1.0/redesign_heli.js')
}
