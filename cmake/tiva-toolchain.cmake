...
set(CMAKE_C_FLAGS "-mthumb ${CPU} ${FPU} -std=gnu18 -ffunction-sections -fdata-sections -Wall -pedantic")
set(CMAKE_CXX_FLAGS "-mthumb ${CPU} ${FPU} -ffunction-sections -fdata-sections -MD -Wall -pedantic -fno-exceptions -fno-rtti")
